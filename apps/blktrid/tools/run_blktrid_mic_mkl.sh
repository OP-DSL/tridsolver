...
SINK_LD_LIBRARY_PATH=${MIC_LD_LIBRARY_PATH} /opt/intel/mic/bin/micnativeloadex ./blktrid_mic_mkl -a "$ARGS" -e "KMP_AFFINITY=$PHI_KMP_AFFINITY KMP_PLACE_THREADS=$KMP_PLACE_THREADS OMP_NUM_THREADS=$OMP_NUM_THREADS"
